...
import cn.aiyangkeji.fragmnets.OrderYysAllFragment;
import cn.aiyangkeji.fragmnets.OrderYysFragment;
import cn.aiyangkeji.fragmnets.OrderproductFragment;
import cn.aiyangkeji.fragmnets.YysServiceOrderFragment;
...
public class MyYysOrderActivity extends BaseFragmentActivity {

    private ImageView ivback;
    private TextView tvCommodity;
    private TextView tvYys;
    private FragmentManager fragmentManager;
    private YysServiceOrderFragment orderYysFragment;
    ...
    public void initData() {
        orderYysFragment = new YysServiceOrderFragment();
