...
import cn.aiyangkeji.adapter.YysCustomerAdapter;
...
public class YysCustomerActivity extends BaseActivity {
    ...
    public void initData() {
        final YysCustomerAdapter adapter = new YysCustomerAdapter(this);
        ...
        adapter.setClickListener(new YysCustomerAdapter.OnItemClickListener() {
            @Override
