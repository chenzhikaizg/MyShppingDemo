...
public class OrderYysServiceAdapter extends BaseAdapter {
    ...
    public OrderYysServiceAdapter(Context mContext, View.OnClickListener clickListener){
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        if (view==null){
            view = layoutInflater.inflate(R.layout.adapter_yys_service_order, null);

            viewHolder = new ViewHolder();
            viewHolder.ivHead = (ImageView)view.findViewById(R.id.iv_head);
            viewHolder.tvOrderName = (TextView)view.findViewById(R.id.tv_name);
