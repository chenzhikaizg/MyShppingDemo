...
public class SyTjFwAdapter extends RecyclerView.Adapter<SyTjFwAdapter.SyTjViewHolder> {
    private List<MyWenDaBean.ArtImage> values;
    private Context mContext;
    public SyTjFwAdapter(Context mContext){
    ...
    public SyTjViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.shou_ye_tjfw_item, parent, false);
