...
public class YysCustomerAdapter extends RecyclerView.Adapter<YysCustomerAdapter.MyWendViewHolder> {
    private List<MyWenDaBean.ArtImage> values;
    private Context mContext;
    public YysCustomerAdapter(Context mContext){
    ...
    public MyWendViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.adapter_yys_customer, parent, false);
