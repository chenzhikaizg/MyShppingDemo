...
public class YzcYouXuanAdapter extends RecyclerView.Adapter<YzcYouXuanAdapter.SyTjViewHolder> {
    private List<SortProductsBean.Products> values;
    private Context mContext;
    public YzcYouXuanAdapter(Context mContext){
        this.mContext = mContext;
        values = new ArrayList<SortProductsBean.Products>();

    }
    public void addData(List<SortProductsBean.Products> values) {
    ...
    public SyTjViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.adapter_yzc_youxuan, parent, false);
