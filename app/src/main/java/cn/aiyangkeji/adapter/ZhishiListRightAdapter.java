...
public class ZhishiListRightAdapter extends BaseAdapter {
    ...
    public ZhishiListRightAdapter(Context mContext, View.OnClickListener clickListener){
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        if (view==null){
            view = layoutInflater.inflate(R.layout.zhishi_list_right, null);

            viewHolder = new ViewHolder();
            viewHolder.ivHead = (ImageView)view.findViewById(R.id.iv_zhishi);
