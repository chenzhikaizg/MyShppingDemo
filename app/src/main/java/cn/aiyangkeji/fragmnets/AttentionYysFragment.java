...
public class AttentionYysFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
         view = inflater.inflate(R.layout.fragment_attention_yys, container, false);
        initView();
        initListener();
        initData();
    ...
    public void initData() {
        AttentionYysAdapter yingYangShiAdapter = new AttentionYysAdapter(getContext(),clickListener);
