...
public class YysPriceFragment extends  BaseFragment implements AutoListView.OnRefreshListener,
    ...
    public void initData() {
        YingYangShiAdapter yingYangShiAdapter = new YingYangShiAdapter(getContext(),clickListener);
