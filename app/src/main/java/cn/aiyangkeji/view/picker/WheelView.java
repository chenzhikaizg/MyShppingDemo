...
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR = 0xFF11b446;

	/** Items text color */
	//private static final int ITEMS_TEXT_COLOR = 0xFF000000;
	private static final int ITEMS_TEXT_COLOR = 0xFFa4b2b2;

	/** Top and bottom shadows colors */
	//private static final int[] SHADOWS_COLORS = new int[] { 0xFF111111, 0x00AAAAAA, 0x00AAAAAA };
	private static final int[] SHADOWS_COLORS = new int[] { R.color.white, R.color.white, R.color.white };
	...
	private void initResourcesIfNecessary() {
		...
		if (centerDrawable == null) {
			...
			centerDrawable = getContext().getResources().getDrawable(R.mipmap.bg_address_selected);
	...
	private void drawValue(Canvas canvas) {
		valuePaint.setColor(getResources().getColor(R.color.pink_word_home));
